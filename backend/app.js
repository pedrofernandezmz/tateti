...
// const port = 8080;
// app.listen(port, () => {
// console.log(`API TATETI escuchando en puerto: ${port}`);
// });

// app.get("/", async (req, res) => {
// res.json({ status: "Backend Tateti Funcionando! Version 1.0" });
// });
...
//     if (err) {
//       console.error('Error al obtener resultados de contador:', err);
